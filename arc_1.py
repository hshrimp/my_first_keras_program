...
def train(num_words,embedding_matrix,x1_train,x2_train,y_train,x1_val,x2_val,y_val):
    ...
    x1=Conv1D(50,4,activation='relu')(embedded_sequences1)
    x1=MaxPooling1D(3)(x1)
    x1=Dropout(0.4)(x1)
    x1=Conv1D(50,2,activation='relu')(x1)
    ...
    x2 = Conv1D(50, 4, activation='relu')(embedded_sequences2)
    x2 = MaxPooling1D(3)(x2)
    x2 = Dropout(0.4)(x2)
    x2 = Conv1D(50, 2, activation='relu')(x2)
    ...
    model.fit([x1_train,x2_train],y_train,batch_size=64,epochs=10,validation_data=([x1_val,x2_val],y_val))
    plot_model(model,to_file='ARC_1.png',show_shapes=True)
