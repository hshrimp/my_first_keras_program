...
def one_hot_tensor(texts11,texts12,labels1,texts21,texts22,labels2):
    onehot=one_hot(texts11+texts12+texts21+texts22,max_nb_words,lower=False,split=' ')
...
def train(num_words,x1_train,x2_train,y_train,x1_val,x2_val,y_val):
    ...
    #x1=Dropout(0.5)(x1)
    x2=Conv1D(500,3,activation='relu',kernel_regularizer=regularizers.l2(0.01))(x1)
    x3=Conv1D(200,3,activation='relu',kernel_regularizer=regularizers.l2(0.01))(x2)
    ...
    plot_model(model,to_file='new3_a14.png',show_shapes=True)
...
if __name__ == '__main__':
    ...
    # one_hot_tensor(x1text_train,x2text_train,train_label,x1text_test,x2text_test,test_label)

    # num_words, embedding_matrix=prepare_embedding(word_index,embeddings_index)
    train(len(word_index)+1, x1_train,x2_train, y_train, x1_val,x2_val, y_val)
