...
from keras.layers import Conv1D,MaxPooling1D,Embedding,Masking
...
def train(num_words,embedding_matrix,x1_train,x2_train,y_train,x1_val,x2_val,y_val):
    ...
    x1=Conv1D(500,3,activation='relu',kernel_initializer='uniform',kernel_regularizer=regularizers.l2(0.01))(embedded_sequences1)
    x1=MaxPooling1D(2)(x1)
    #x1=Dropout(0.5)(x1)
    x1=Conv1D(500,3,activation='relu',kernel_initializer='uniform',kernel_regularizer=regularizers.l2(0.01))(x1)
    x1 = MaxPooling1D(2)(x1)
    #x1 = Dropout(0.5)(x1)
    ...
    x = Dense(128,activation='relu',kernel_initializer='uniform',kernel_regularizer=regularizers.l2(0.01))(x)
    # x = Dropout(0.5)(x)
    # x = Dense(64, activation='relu')(x)
    # x = Dropout(0.25)(x)
    preds = Dense(1,activation='sigmoid',kernel_initializer='uniform',kernel_regularizer=regularizers.l2(0.01))(x)
    ...
    plot_model(model,to_file='ARC_12uniform.png',show_shapes=True)
