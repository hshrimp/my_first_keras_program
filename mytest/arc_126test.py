...
def train(num_words,embedding_matrix,x1_train,x2_train,y_train,x1_val,x2_val,y_val):
    ...
    #x1=Dropout(0.5)(x1)
    x1=Conv1D(1,3,strides=3,activation='relu',kernel_regularizer=regularizers.l2(0.01))(x1)
    #x1 = AveragePooling1D(3)(x1)
    #x1 = Dropout(0.5)(x1)
    ...
    plot_model(model,to_file='ARC_126test.png',show_shapes=True)
