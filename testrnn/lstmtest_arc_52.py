...
def train(num_words, embedding_matrix,  x1_train,x2_train, y_train, x1_val,x2_val, y_val):
    ...
    x=LSTM(embedding_dim,return_sequences=True,go_backwards=True)(embedded_sequences)
    ...
    plot_model(model,to_file='lstmbacktestARC_5_2.png',show_shapes=True)
